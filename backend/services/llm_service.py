...
def analyze_profile_with_gemini(
    ...
    prompt = (
        ...
        "the job description. In skill_gaps, clearly distinguish a confirmed skill "
        "gap from a job requirement that is merely not evidenced in the supplied "
        "profile. Produce a calibrated match_score from 0 to 100. Write every "
        "next_steps item directly to the candidate with an actionable verb such as "
